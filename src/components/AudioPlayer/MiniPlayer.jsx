...
export default function MiniPlayer() {
  const {
    ...
    playing, currentTime, duration, isLoaded,
      ...
      {expanded && (
        <div className="mini-player-expanded-body">
          ...
          <div className="mini-player-expanded-controls">
            <button className="mini-player-btn" onClick={previousChapter} disabled={tracks.length <= 1 || !isLoaded} aria-label="Previous chapter">
              <SkipBack size={20} />
            </button>
            ...
            <button className="mini-player-btn" onClick={nextChapter} disabled={currentTrackIndex >= tracks.length - 1 || !isLoaded} aria-label="Next chapter">
              <SkipForward size={20} />
            </button>
          </div>
          <button
