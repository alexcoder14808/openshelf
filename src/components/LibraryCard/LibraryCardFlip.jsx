...
export default function LibraryCardFlip({ membership }) {
  ...
  // 12 digits grouped as "1234 5678 9012" — much easier to read than one
  // unbroken run of numbers, same convention as a real card.
  const formattedCardNumber = cardNumber ? cardNumber.replace(/(\d{4})(?=\d)/g, '$1 ') : '';
        ...
        <div className="library-flip-card-face library-flip-card-back">
          ...
          <div className="library-flip-card-details">
            <div>
              ...
              <span className="library-flip-card-value">{formattedCardNumber}</span>
            </div>
            <div>
