    ...
    <div className="page" style={{ maxWidth: 760 }}>
      ...
      <div style={{ color: '#40444c', lineHeight: 1.75, fontSize: '0.95rem' }}>
        <p>
          ...
          "Service"), operated by OpenShelf Technologies, Inc. ("OpenShelf," "we," "us," or "our"). By creating
        ...
        <p>
          If you believe Library Content available on OpenShelf infringes your copyright under the
          Copyright Act 1968 (Cth) or any other applicable law, contact us at
          pixelpetshelter@gmail.com with: (a) identification of the copyrighted work claimed to be
          infringed; (b) identification of the material you claim is infringing and its location on
          the Service; (c) your contact information; (d) a statement that you have a good-faith
          belief the use is unauthorized; and (e) a statement that the information is accurate and
          that you are authorized to act on behalf of the copyright owner. We may remove or disable
          access to reported content and/or terminate the accounts of repeat infringers, at our
        ...
        <p>
          Nothing in this clause excludes, restricts, or modifies any guarantee, warranty, term, or
          condition, or any right or remedy, implied or imposed by the Australian Consumer Law
          (Schedule 2 to the Competition and Consumer Act 2010 (Cth)) or any other applicable law
          that cannot lawfully be excluded or limited. Where OpenShelf's liability for a failure to
          comply with a non-excludable consumer guarantee cannot be excluded but can be limited,
          OpenShelf's liability is limited, to the extent permitted by law, to re-supplying the
        ...
        <p>
          ...
          OPENSHELF, IF ANY, IN THE 12 MONTHS PRECEDING THE CLAIM, OR (B) AUD $100.
        </p>
        <p>
          This limitation applies only to the extent permitted by law and does not apply to, exclude,
          or limit any non-excludable guarantee, right, or remedy under the Australian Consumer Law.
        </p>
        ...
        <p>
          ...
          expenses (including reasonable legal costs) arising out of or in any way connected
        ...
        <p>
          You must be at least 16 years old to create an OpenShelf account. If you are creating a
          Library or acting as a Library Administrator, you represent that you have the legal
          authority to enter into these Terms on behalf of yourself or any organization you
          represent.
        </p>
        ...
        <p>
          These Terms are governed by the laws of Australia. Any disputes arising out of or
          relating to these Terms or the Service shall be subject to the non-exclusive jurisdiction
          of the courts of Australia.
        </p>

        <h2>11. Contact</h2>
        <p>Questions about these Terms can be sent to pixelpetshelter@gmail.com.</p>
