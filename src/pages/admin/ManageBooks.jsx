...
import { Plus, Pencil, Trash2, Settings, Minus, Users } from 'lucide-react';
    ...
    <div className="page">
      <div className="page-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', flexWrap: 'wrap', gap: 12 }}>
        ...
        <div style={{ display: 'flex', gap: 10 }}>
          <Link to={`/admin/${libraryId}/members`} className="toolbar-btn" style={{ textDecoration: 'none' }}>
            <Users size={16} /> <span>Manage people</span>
          </Link>
