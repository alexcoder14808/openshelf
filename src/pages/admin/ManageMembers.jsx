...
export default function ManageMembers() {
  ...
  const { adminLibraries, approveMember, rejectMember } = useLibrary();
  ...
  return (
    <div className="page">
      <div className="page-header">
        <h1>{adminEntry.library.name} — Manage People</h1>
        <p>Approve or decline card requests, and see who currently holds a card.</p>
      </div>
