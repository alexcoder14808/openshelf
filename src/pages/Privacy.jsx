    ...
    <div className="page" style={{ maxWidth: 760 }}>
      ...
      <div style={{ color: '#40444c', lineHeight: 1.75, fontSize: '0.95rem' }}>
        <p>
          ...
          how we use it, and your choices, when you use the OpenShelf platform (the "Service").
        </p>
        ...
        <p>
          ...
          your membership and card for that Library. To delete your OpenShelf account entirely,
          contact us at [CONTACT EMAIL].
        </p>

        <h2>7. Children's Privacy</h2>
        <p>
          The Service is not directed at children under [AGE, e.g. 13], and we do not knowingly
          collect personal information from children under that age. If you believe a child has
          provided us personal information, contact us at [CONTACT EMAIL].
        </p>
