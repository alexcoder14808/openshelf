...
export function LibraryProvider({ children }) {
  ...
  // catalog like any other patron). A random PIN is generated for their
  // own card since they're not prompted for one during library creation —
  // they can view/change it from their Library Card page like anyone else.
